...
public class GivenBlackBox {
     ...
     */
    @Test
    public void rVsBSunnyGroundGreaterThan0() throws Exception {

        Mascotmon attacker1 = new Mascotmon(Mascotmon.Name.RALPHIE);
        Mascotmon defender1 = new Mascotmon(Mascotmon.Name.BULLY);

        BattleScenario fight1 = createBattleScenario(attacker1, defender1);
        System.out.println("    rVsBSunnyGroundGreaterThan0");
        ...
        System.out.println("        Damage dealt: " + damage);
        Assert.assertEquals(9999, damage, 0.2);
    }
     ...
     */
    @Test
    public void rVsBSunnyNormalGreaterThan0() throws Exception {

        Mascotmon attacker1 = new Mascotmon(Mascotmon.Name.RALPHIE);
        Mascotmon defender1 = new Mascotmon(Mascotmon.Name.BULLY);

        BattleScenario fight1 = createBattleScenario(attacker1, defender1);
        System.out.println("    rVsBSunnyNormalGreaterThan0");
     ...
     */
    @Test
    public void bVsRDroughtNormalGreaterThan0() throws Exception {

        Mascotmon attacker1 = new Mascotmon(Mascotmon.Name.BULLY);
        Mascotmon defender1 = new Mascotmon(Mascotmon.Name.RALPHIE);

        BattleScenario fight1 = createBattleScenario(attacker1, defender1);
        System.out.println("    bVsRDroughtNormalGreaterThan0");
     ...
     */
    @Test
    public void bVsRNeutralNormalGreaterThan0() throws Exception {

        Mascotmon attacker1 = new Mascotmon(Mascotmon.Name.BULLY);
        Mascotmon defender1 = new Mascotmon(Mascotmon.Name.RALPHIE);

        BattleScenario fight1 = createBattleScenario(attacker1, defender1);
        System.out.println("    bVsRNeutralNormalGreaterThan0");
     ...
     */
    @Test
    public void sVsRNeutralNormalGreaterThan0() throws Exception {

        Mascotmon attacker1 = new Mascotmon(Mascotmon.Name.SPARKY);
        Mascotmon defender1 = new Mascotmon(Mascotmon.Name.RALPHIE);

        BattleScenario fight1 = createBattleScenario(attacker1, defender1);
        System.out.println("    sVsRNeutralNormalGreaterThan0");
     ...
     */
    @Test
    public void rVsSNeutralNormalGreaterThan0() throws Exception {

        Mascotmon attacker1 = new Mascotmon(Mascotmon.Name.RALPHIE);
        Mascotmon defender1 = new Mascotmon(Mascotmon.Name.SPARKY);

        BattleScenario fight1 = createBattleScenario(attacker1, defender1);
        System.out.println("    rVsSNeutralNormalGreaterThan0");
     ...
     */
    @Test
    public void rVsANeutralNormalGreaterThan0() throws Exception {

        Mascotmon attacker1 = new Mascotmon(Mascotmon.Name.RALPHIE);
        Mascotmon defender1 = new Mascotmon(Mascotmon.Name.ALBERT);

        BattleScenario fight1 = createBattleScenario(attacker1, defender1);
        System.out.println("    rVsANeutralNormalGreaterThan0");
     ...
     */
    @Test
    public void rVsBNeutralNormalGreaterThan0() throws Exception {

        Mascotmon attacker1 = new Mascotmon(Mascotmon.Name.RALPHIE);
        Mascotmon defender1 = new Mascotmon(Mascotmon.Name.BULLY);

        BattleScenario fight1 = createBattleScenario(attacker1, defender1);
        System.out.println("    rVsBNeutralNormalGreaterThan0");
     ...
     */
    @Test
    public void rVsBDroughtNormalGreaterThan0() throws Exception {

        Mascotmon attacker1 = new Mascotmon(Mascotmon.Name.RALPHIE);
        Mascotmon defender1 = new Mascotmon(Mascotmon.Name.BULLY);

        BattleScenario fight1 = createBattleScenario(attacker1, defender1);
        System.out.println("    rVsBDroughtNormalGreaterThan0");
     ...
     */
    @Test
    public void aVsRDroughtWaterGreaterThan0() throws Exception {

        Mascotmon attacker1 = new Mascotmon(Mascotmon.Name.ALBERT);
        Mascotmon defender1 = new Mascotmon(Mascotmon.Name.RALPHIE);

        BattleScenario fight1 = createBattleScenario(attacker1, defender1);
        System.out.println("    aVsRDroughtWaterGreaterThan0");
